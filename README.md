...
This starter project will allow you to run automated tests on native iOS or Android browsers (physical device or simulator)
...
4. Install ChromeDriver:
  - In PowerShell via scoop: `scoop install chromedriver`
  - Or install manually [here](https://sites.google.com/a/chromium.org/chromedriver/downloads). Be sure to add Chromedriver to your [PATH](http://www.howtogeek.com/118594/how-to-edit-your-system-path-for-easy-command-line-access/)
5. Install geckodriver from [here](https://github.com/mozilla/geckodriver/releases). Be sure to add it to your PATH as well.
6. Cd to the project directory and install the necessary ruby gems
